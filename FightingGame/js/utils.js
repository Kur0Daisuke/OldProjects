...
function determineWinner({player, enemy, timerId, mode}) {
    clearTimeout(timerId)
    document.querySelector('#EndScreen').style.display = 'flex'
    if(mode === 'ai' && player.health > enemy.health) {
        document.querySelector('#EndScreen-button-evil').style.display = 'flex'
    }else {
    ...
    if(player.health === enemy.health) {
        ...
        if(mode === 'ai') {
            document.querySelector('#EndScreen').innerHTML = 'Too Ez?'
        }else {
        ...
        if(mode === 'ai') {
            document.querySelector('#EndScreen').innerHTML = 'Oof What a failure'
        }else {
